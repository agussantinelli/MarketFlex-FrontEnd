...
describe('AdminAuthInputs Component', () => {
    const mockFormData = {
        nombre: 'Juan',
        apellido: 'Perez',
        dni: '12345678',
    ...
    it('renders all fields with correct initial values', () => {
        render(<AdminAuthInputs formData={mockFormData} onChange={mockOnChange} />);
    ...
    it('shows password hint when not in edit mode', () => {
        render(<AdminAuthInputs formData={mockFormData} onChange={mockOnChange} isEdit={false} />);
