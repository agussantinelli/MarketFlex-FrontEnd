...
describe('EditSaleView Component', () => {
    ...
    it('renders nothing (null) while loading', () => {
        (AdminService.getPurchaseById as any).mockImplementation(
    ...
    it('renders the edit form with sale data after loading', async () => {
        (AdminService.getPurchaseById as any).mockResolvedValue(mockSale);
        ...
        expect(AdminService.getPurchaseById).toHaveBeenCalledWith('sale-1');
    });
