...
describe('EditProductView', () => {
    beforeEach(() => {
        ...
        (AdminService.getAdminProduct as any).mockResolvedValue(mockProductData);
    });
    ...
    it('should render and load product data', async () => {
        ...
        await waitFor(() => {
            expect(AdminService.getAdminProduct).toHaveBeenCalledWith('123');
        });
    ...
    it('should call updateProduct on submit', async () => {
        (AdminService.updateProduct as any).mockResolvedValue({ status: 'success' });
    ...
    it('should handle errors during update', async () => {
        (AdminService.updateProduct as any).mockResolvedValue({ status: 'error', message: 'Error de prueba' });
