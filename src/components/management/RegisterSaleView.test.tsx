...
// Mock ManagementService and API
...
describe('RegisterSaleView Component', () => {
    ...
    it('completes the full 3-step registration flow', async () => {
        (ManagementService.searchProducts as any).mockResolvedValue([mockProduct]);
    ...
    it('triggers Sileo notifications when adding/removing products', async () => {
        (ManagementService.searchProducts as any).mockResolvedValue([{ id: 'p1', nombre: 'Test Prod', precioActual: 100, stock: 10, foto: null }]);
