...
const ManagementAuthInputs: React.FC<ManagementAuthInputsProps> = ({ formData, onChange, readonlyFields = [], isEdit = false, hasPassword = true }) => {
...
export default ManagementAuthInputs;
