...
describe('SalesListView Component', () => {
    ...
    it('fetches and renders sales data on mount', async () => {
        (ManagementService.getAllPurchases as any).mockResolvedValue(mockSales);

        render(<SalesListView />);

        await waitFor(() => {
            expect(ManagementService.getAllPurchases).toHaveBeenCalled();
        });
    ...
    it('renders error state when fetch fails', async () => {
        (ManagementService.getAllPurchases as any).mockRejectedValue(new Error('API Error'));
    ...
    it('renders empty state when no sales are returned', async () => {
        (ManagementService.getAllPurchases as any).mockResolvedValue([]);
