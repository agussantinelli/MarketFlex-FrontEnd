...
<ul>
  ...
  <li>🧪 <b>100% Logic Coverage:</b> Todos los scripts interactivos en <code>src/scripts</code> y servicios de comunicación cuentan con tests unitarios robustos (<b>142 tests en total</b>), garantizando la fiabilidad de la UI y la sesión.</li>
